...
# Agora, a equipe precisa corrigir a ordem dos eventos para garantir que a 
# conferência aconteça conforme o planejamento original.
...
eventos_registrados = ['Encerramento', 'Palestra 3', 'Palestra 2', 'Abertura']
eventos_registrados.reverse()  # Inverte a ordem
